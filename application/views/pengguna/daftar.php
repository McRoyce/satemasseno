...
<head>
    ...
    <title>Sate Mas Seno - Daftar</title>
...
<body>
    ...
    <h3 class="text-center"><span class="underline">Mendaftar</span></h3>
        <form action="<?php echo base_url().'singup/create_user'; ?>" method="POST" id="myForm" name="myForm"
            ...
            <div class="text-center">
                <button type="submit" class="btn green-button liquidgreen mt-3">Buat Akun</button>
                <p style="margin-top:0.5rem;">Sudah daftar? 
                <a href="<?php echo base_url().'login/index';?>">Klik disini!</a></p>
            </div>
        </form>
    </div>
