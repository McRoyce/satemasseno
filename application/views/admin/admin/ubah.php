...
<div class="col-md-8 mx-auto animate__animated animate__fadeInLeftBig">
    <form action="<?php echo base_url().'admin/admin/edit/'.$admin['id_a']; ?>" method="POST"
        class="card mx-auto" id="myForm" enctype="multipart/form-data">
        <h3 class="text-center"><span class="underline">Ubah Admin</span></h3>
            <div class="avatar-upload mt-3">
                <div class="avatar-preview">
                        <?php if($admin['foto'] != "" && file_exists('./public/uploads/admins/'.$admin['foto'])) { ?>
                    <img id="imagePreview" src="<?php echo base_url().'public/uploads/admins/'.$admin['foto'];?>">
                        <?php } else { ?>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('username') != "") ? 'is-invalid' : '';?>" name="username"
                        value="<?php echo set_value('username', $admin['nama_a'])?>" autocomplete="off"
                            required>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('firstname') != "") ? 'is-invalid' : '';?>" name="firstname"
                        value="<?php echo set_value('firstname', $admin['nama_d'])?>" autocomplete="off"
                            required>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('lastname') != "") ? 'is-invalid' : '';?>" name="lastname"
                        value="<?php echo set_value('lastname', $admin['nama_b'])?>" autocomplete="off"
                            required>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('email') != "") ? 'is-invalid' : '';?>" name="email" 
                        value="<?php echo set_value('email', $admin['email'])?>" autocomplete="off"
                            required>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('phone') != "") ? 'is-invalid' : '';?>" name="phone" 
                        value="<?php echo set_value('phone', $admin['telepon'])?>" autocomplete="off"
                            required>
                ...
                <div class="form-group">
                    ...
                    <?php echo (form_error('password') != "") ? 'is-invalid' : '';?>" name="password"
                        value="<?php echo set_value('password', $admin['sandi'])?>" autocomplete="off"
                            required>
        ...
        <div class="form-group">
            <textarea name="address" id="address" type="text" class="form-control
                <?php echo (form_error('address') != "") ? 'is-invalid' : '';?>" autocomplete="off"
                            required><?php echo set_value('address', $admin['alamat']);?></textarea>
