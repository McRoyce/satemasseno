...
<div class="animate__animated animate__fadeInLeftBig">
    <div class="card">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h3><span class="underline">Daftar Admin</span></h3>
            </div>
        ...
        <div class="d-flex justify-content-between align-items-left">
            ...
            <div>
                <a href="<?php echo base_url().'admin/admin/create_admin';?>"
                class="mt-2 btn btn-info"><i class="fas fa-plus"></i> Buat Admin</a>
            </div>
        </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <?php if($admin['foto'] != "" && file_exists('./public/uploads/admins/thumb/'.$admin['foto'])) { ?>
                                <img class="imgprofile" height="100" width="100" src="<?php echo base_url().'public/uploads/admins/thumb/'.$admin['foto'];?>">
                            <?php } else { ?>
                        ...
                        <td><?php echo $admin['nama_a']; ?></td>
                        <td><?php echo $admin['nama_d']; ?></td>
                        <td><?php echo $admin['nama_b']; ?></td>
                        <td><?php echo $admin['email']; ?></td>
                        <td><?php echo $admin['telepon']; ?></td>
                        <td><?php echo $admin['alamat']; ?></td>
                        <td>
                            <a href="<?php echo base_url().'admin/admin/edit/'.$admin['id_a'];?>"
                                class="btn btn-info btn-block"><i
                                    class="fas fa-edit"></i></a>
                            <a href="javascript:void(0);" onclick="deleteAdmin(<?php echo $admin['id_a']; ?>)"
...
<h3 id="h3">Yah, adminnya gak ada...</h3>
...
function deleteAdmin(id) {
    if (confirm("Yakin ingin menghapus admin?")) {
        window.location.href = '<?php echo base_url().'admin/admin/delete/';?>' + id;
    }
}
