<head>
    <title>Sate Mas Seno - Ubah Kategori</title>
...
<div class="col-md-8 card mx-auto animate__animated animate__fadeInLeftBig">
    <h3 class="text-center"><span class="underline">Ubah Kategori</span></h3>
    <form action="<?php echo base_url().'admin/category/edit/'.$cat['id_k'];?>" class="container" method="POST" id="myForm">
        <div class="form-group mt-5">
            <input type="text" class="form-control" id="category" name="category" value="<?php echo set_value('category', $cat['nama_k']);?>"
                autocomplete="off" required>
            <label class="input-label" for="category">Nama Kategori</label><i class="bar"></i>
